...
from keras.layers import Conv2D, UpSampling2D, Input, BatchNormalizationV2, Conv2DTranspose  # Импорт определенных
# классов из модуля layers из пакета keras для создания слоев модели
from keras.models import Model  # Импорт класса Model из модуля models из пакета keras для создания модели
from keras.callbacks import BackupAndRestore, CSVLogger  # Импорт определенных классов из модуля callbacks из пакета
# keras для обратных вызовов во время обучения модели
